...
Le rendement d'un moteur ditherme s'écrit donc:

$$
\rho = \frac{\vert W \vert}{Q_c}
$$

````{important} __Rendement de Carnot du moteur ditherme__
...
Les rendements des centrales nucléaires actuelles tourne autour de $30\%$ à $40\%$ alors que le rendement des centrales thermiques a été amélioré pour pouvoir dépasser plus de $50\%$. Mais les centrales nucléaires produisent beaucoup plus de puissance malgré leur plus faible rendement.
````
